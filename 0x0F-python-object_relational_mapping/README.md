...
2. [mysqlclient/MySQLdb documentation](https://mysqlclient.readthedocs.io) (*please don’t pay attention to* `_mysql`)
...
11. [SQLAlchemy ORM Tutorial for Python Developers](https://auth0.com/blog/sqlalchemy-orm-tutorial-for-python-developers/) (***Warning:*** *This tutorial is with PostgreSQL, but the concept of SQLAlchemy is the same with MySQL*)
